...
from text_opinion_filter import TextOpinionFilter, FrameworkLimitationsTextOpinionFilter
...
def iter_text_opinion_linkages(parsed_news, annotators, text_opinion_filters):
